...
from src_new.utils_round2new import *
...
def get_data(tokenizer, max_length, args):
    ...
    data = load_data_for_training(args.annotations_path, args.captions_path, args.summary_path)
...
def main(args):
    ...
    output_dir = os.path.join(args.experiments_dir, "rag_7M_gpt2_round2_14m")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--summary_path", type=str, default="data/summary_prompt_dataset2_14m.json", help="JSON file with")
